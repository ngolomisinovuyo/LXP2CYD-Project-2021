...
{
    public abstract class LXP2CYDWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LXP2CYDWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LXP2CYDWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LXP2CYDDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LXP2CYDDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LXP2CYDDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LXP2CYDDbContext, Task<T>> func)
        {
            T result;
